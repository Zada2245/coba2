...
import 'game_store.dart'; // Impor model GameStore
...
class _DetailPageState extends State<DetailPage> {
  ...
  Future<void> _launchUrl() async {
    final Uri url = Uri.parse(widget.game.linkStore);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Menggunakan warna latar belakang yang sedikit lebih cerah dari hitam pekat
  ...
  Widget _buildSliverAppBar() {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: Hero(
          tag:
              widget.game.name, // Gunakan tag yang sama dari halaman sebelumnya
          child: Stack(
            fit: StackFit.expand,
            children: [
              PageView.builder(
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: List.generate(widget.game.imageUrls.length, (
                    index,
                  ) {
  ...
  // WIDGET BARU: Tampilan Review dalam bentuk kartu statistik
        ...
        child: ElevatedButton.icon(
          ...
          style:
              ElevatedButton.styleFrom(
                ...
                backgroundColor:
                    Colors.transparent, // Warna dasar transparan untuk gradien
                foregroundColor: Colors.white,
